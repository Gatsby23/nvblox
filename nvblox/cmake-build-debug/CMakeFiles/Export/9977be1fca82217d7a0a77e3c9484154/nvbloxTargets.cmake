...
foreach(_cmake_expected_target IN ITEMS nvblox::nvblox_lib nvblox::nvblox_gpu_hash nvblox::nvblox_datasets nvblox::stdgpu nvblox::nvblox_eigen nvblox::fuse_3dmatch nvblox::fuse_replica)
...
set_target_properties(nvblox::nvblox_lib PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/usr/local/cuda-11.8/targets/x86_64-linux/include;/usr/include;${_IMPORT_PREFIX}/include/nvblox"
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libglog.so;gflags;nvblox::nvblox_eigen;nvblox::nvblox_gpu_hash"
...
set_target_properties(nvblox::nvblox_gpu_hash PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "nvblox::stdgpu;nvblox::nvblox_eigen;/usr/local/cuda-11.8/targets/x86_64-linux/lib/libnvToolsExt.so;/usr/lib/x86_64-linux-gnu/libglog.so;\$<LINK_ONLY:gflags>"
  INTERFACE_LINK_OPTIONS "-Wl,--disable-new-dtags"
)
